...
class C3DModel
{
	protected:
		...
		unsigned short *m_vertexIndices=NULL;                                  // Dynamically-allocated array of vertex indices for this model
		unsigned short *m_normalIndices = NULL;                                  // Dynamically-allocated array of normal indices for this model
		unsigned short *m_UVindices = NULL;                                      // Dynamically-allocated array of UV coord indices for this model
	
		float *m_verticesRaw = NULL;                                             // Dynamically-allocated array of vertices (raw float values)
		float *m_normalsRaw = NULL;                                              // Dynamically-allocated array of normals (raw float values)
		float *m_uvCoordsRaw = NULL;                                             // Dynamically-allocated array of UV coords (raw float values)
		...
		map<string, string> m_materialFilenames;
		map<string, CVector3>    m_materialColors;
